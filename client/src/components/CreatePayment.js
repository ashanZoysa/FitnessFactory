...
export default class CreatePayment extends Component {
    ...
    onChangeDemo() {
        this.setState({
            userName: "Kevin",
            paymentDate: new Date("2020-02-14T20:49:29.000+00:00"),
            category:"Membership Fees",
            description:"Receive 6 months membership",
            amount:"15000.00"  
        })
    }
        ...
        return (
            ...
            <div className="col-md-8 mt-4 mx-auto">
                ...
                <form className="needs-validation" onSubmit={this.onSubmit}>
                    ...
                    <button type="submit" className="btn btn-success" style={{ margin: '15' }} ><i className="fas fa-plus"></i>&nbsp;&nbsp;Add New Payment</button>&nbsp;&nbsp;


                </form>

                <br />
                <button onClick={this.onChangeDemo} className="btn btn-primary" style={{ margin: '15' }} >&nbsp;&nbsp;Demo Payment</button>&nbsp;&nbsp;
